...
namespace Motax.Migrations
{
    ...
    [Migration("20240723113438_AddDeliveryUnitAndServiceUnit")]
    partial class AddDeliveryUnitAndServiceUnit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Motax.Models.DeliveryUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Motax.Models.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Motax.Models.ServiceUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Motax.Models.CarRegistration", b =>
                {
                    ...
                    b.HasOne("Motax.Models.OrderStatus", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("Motax.Models.DeliveryUnit", b =>
                {
                    ...
                    b.HasOne("Motax.Models.ServiceUnit", "ServiceUnit")
                        .WithMany()
